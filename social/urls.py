...
from .views import PostDeleteView,PostDetailView,PostEditView,AddDislike,AddLike,CommentEditView,CommentDeleteView,CommentReplyView,AddCommentLike,AddCommentDislike
app_name="social"
